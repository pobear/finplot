...
ax1, ax2, ax3, ax4, ax5 = fplt.create_plot(
    "Bitcoin/Dollar long term analysis", rows=5, maximize=False
)
...
btc["one"] = 1
fplt.volume_ocv(
    btc[["ma200", "ma50", "one"]], candle_width=1, ax=ax1.overlay(scale=0.02)
)
...
colmap = fplt.ColorMap(
    [0.3, 0.5, 0.7], [[255, 110, 90], [255, 247, 0], [60, 255, 50]]
)  # traffic light
...
ax5.set_visible(
    crosshair=False, xaxis=False, yaxis=False
)  # hide junk for a more pleasing look
